...
var embed1 = new Discord.RichEmbed()// log kanalı yoksa burayı silin
  .setDescription(`**<@${message.author.id}> Tarafından ${user.user} Adlı kullanıcının ismi \`✯ ${isim}\` Olarak değiştirilip <@&743151515811971222> rolü verilmiştir. <a:ytik:710053175801151529>**`)
  ...
  user.addRole('743151515811971222')
